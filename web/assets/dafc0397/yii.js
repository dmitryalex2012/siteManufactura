...
window.yii = (function ($) {
    var pub = {
         ...
         * For other elements, either the containing form action or the current products URL will be used
        ...
        /**
         * Returns the URL of the current products without params and trailing slash. Separated and made public for testing.
         * @returns {string}
         */
        ...
        /**
         * Returns the URL of the current products. Used for testing, you can always call `window.location.href` manually
         * instead.
         * @returns {string}
         */
